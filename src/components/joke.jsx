...
export default function joke() {
    ...
    const fetchJoke = async () => {
        try {
            const response = await axios.get('http://localhost:5000/random_joke');
    ...
    return (
        <div className={`joke-container ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
            <div className='darkmode-toogle'>
                <label class="switch">
                    ...
                    <input type="checkbox" class="input" onChange={handleToggle} />
